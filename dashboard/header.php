        ...
        <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
            <div class="container-fluid"> <!--begin::Start Navbar Links-->
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"> <a href="dashboard.php" class="nav-link">Anasayfa</a> </li>
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> 
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            ...
                            <li class="user-footer"> <a href="profile.php" class="btn btn-default btn-flat">Profile</a> <a href="php/logout.php" class="btn btn-default btn-flat float-end">Oturumu Kapat</a> </li> <!--end::Menu Footer-->
                        </ul>
